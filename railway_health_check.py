...
class HealthCheckHandler(BaseHTTPRequestHandler):
    ...
    def send_health_response(self):
        ...
        try:
            ...
            if hasattr(self.server, 'bot_status_func') and self.server.bot_status_func:
                try:
...
class HealthCheckServer:
    ...
    def __init__(self, port: int = 8000, bot_status_func: Optional[callable] = None):
        self.port = port
        self.bot_status_func = bot_status_func
    ...
    def start(self):
        ...
        try:
            ...
            print(f"🏥 Health check server running on http://0.0.0.0:{self.port}/health")
...
def start_health_check_server(port: int = 8000, bot_status_func: Optional[callable] = None):
